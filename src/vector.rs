...
impl Vec2 {
    ...
    pub fn smoothstep(edge0: Self, edge1: Self, x: Self) -> Self {
        Self(
            crate::common::smoothstep(edge0.0, edge1.0, x.0),
            crate::common::smoothstep(edge0.1, edge1.1, x.1),
        )
    }

    pub fn smootherstep(edge0: Self, edge1: Self, x: Self) -> Self {
        Self(
            crate::common::smootherstep(edge0.0, edge1.0, x.0),
            crate::common::smootherstep(edge0.1, edge1.1, x.1),
        )
    }
...
impl Vec3 {
    ...
    pub fn smoothstep(edge0: Self, edge1: Self, x: Self) -> Self {
        Self(
            crate::common::smoothstep(edge0.0, edge1.0, x.0),
            crate::common::smoothstep(edge0.1, edge1.1, x.1),
            crate::common::smoothstep(edge0.2, edge1.2, x.2),
        )
    }
    ...
    pub fn smootherstep(edge0: Self, edge1: Self, x: Self) -> Self {
        Self(
            crate::common::smootherstep(edge0.0, edge1.0, x.0),
            crate::common::smootherstep(edge0.1, edge1.1, x.1),
            crate::common::smootherstep(edge0.2, edge1.2, x.2),
        )
    }
...
impl Vec4 {
    ...
    pub fn smoothstep(edge0: Self, edge1: Self, x: Self) -> Self {
        Self(
            ...
            crate::common::smoothstep(edge0.1, edge1.1, x.1),
            crate::common::smoothstep(edge0.2, edge1.2, x.2),
            crate::common::smoothstep(edge0.3, edge1.3, x.3),
        )
    }
    ...
    pub fn smootherstep(edge0: Self, edge1: Self, x: Self) -> Self {
        Self(
            ...
            crate::common::smootherstep(edge0.1, edge1.1, x.1),
            crate::common::smootherstep(edge0.2, edge1.2, x.2),
            crate::common::smootherstep(edge0.3, edge1.3, x.3),
        )
    }
